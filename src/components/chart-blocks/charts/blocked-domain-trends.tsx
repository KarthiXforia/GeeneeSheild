...
import { useBlockedDomainTrends } from "@/hooks/useBlockedDomainTrends";
...
export default function BlockedDomainTrends() {
  ...
  const { data, error, isLoading, startDate, endDate } = useBlockedDomainTrends(
    {
      period: timeframe,
    ...
    return (
      <div className="flex h-[500px] w-full items-center justify-center">
        <p className="text-destructive">
          Failed to load blocked domain data. Please try again later.
        </p>
      </div>
    );
  }
      ...
      <div className="mb-6 flex justify-between">
        <div>
          <p className="text-sm text-muted-foreground">
            Showing {timeframe} blocked domain trends
            {startDate && endDate && (
              <span className="ml-1">
        ...
        {chartData.length > 0 ? (
          ...
          <div className="flex h-full w-full items-center justify-center">
            <p className="text-muted-foreground">
              No blocked domain data available for this period
            </p>
          </div>
        )}
      </div>
